  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="relative" style={{ zIndex: 10 }}>
        ...
        <div className="relative container mx-auto px-4 pt-10 pb-32 md:pt-24 md:pb-40 flex flex-col items-center text-center">
          <motion.h1
        ...
        <div className="absolute left-1/2 -translate-x-1/2 -bottom-[238px] md:-bottom-[40px] w-[85%] max-w-[1100px] md:w-full md:px-4" style={{ zIndex: 20 }}>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <div className="h-[258px] md:h-[60px]" />
