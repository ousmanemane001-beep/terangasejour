        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1" data-booking-widget>
              {isUUID && id ? (
                <BookingWidget listingId={id} pricePerNight={listing.price} maxGuests={listing.guests} bookingMode={dbListing ? (dbListing as any).booking_mode : "instant"} hostId={dbListing?.user_id} listingImage={listing.coverImage} listingTitle={listing.title} />
              ) : (
