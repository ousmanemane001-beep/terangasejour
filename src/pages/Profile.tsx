      ...
      <div className="min-h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center bg-warm-gray">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-6">Accédez à votre profil.</p>
            <Link to="/login">
                ...
                <CardContent className="p-6">
                  ...
                  <div className="mt-6 pt-4 border-t border-border text-left space-y-3">
                    <div className="flex items-center gap-2 text-sm text-muted-foreground">
                      ...
                      <span>{listings?.length || 0} logement{(listings?.length || 0) > 1 ? "s" : ""}</span>
                    </div>
                    {phone && (
                      <div className="flex items-center gap-2 text-sm text-muted-foreground">
                    ...
                    <CardContent className="space-y-6">
                      <div className="p-4 rounded-xl bg-muted/50">
                        <div className="flex items-center justify-between">
                          ...
                          <Button variant="outline" size="sm" className="rounded-full" onClick={() => navigate("/forgot-password")}>Modifier</Button>
                        </div>
                      </div>
                ...
                <TabsContent value="payment">
                  <Card className="border-none shadow-[var(--shadow-card)]">
                    ...
                    <CardContent className="space-y-4">
                      <p className="text-sm text-muted-foreground">Les paiements via Wave, Orange Money et carte bancaire seront bientôt disponibles.</p>
                      <div className="grid grid-cols-3 gap-3">
                        {["Wave", "Orange Money", "Carte bancaire"].map((method) => (
                          <div key={method} className="p-4 rounded-xl bg-muted/50 text-center">
                            ...
                            <Badge variant="outline" className="mt-1 text-[10px]">Bientôt</Badge>
                          </div>
                        ))}
                      </div>
                    </CardContent>
