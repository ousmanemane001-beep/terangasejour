...
import {
  ...
  ChevronDown, Map as MapIcon, LayoutGrid
} from "lucide-react";
      ...
      <div className="sticky top-16 z-40 bg-background border-b border-border shadow-sm">
        <div className="container mx-auto px-4 py-3">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {/* Search button */}
            <Button className="rounded-full bg-accent text-accent-foreground gap-2 px-6">
      ...
      <AnimatePresence>
        {showFilters && (
          <motion.div
            ...
            className="overflow-hidden border-b border-border bg-warm-gray"
          >
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    {[0, 2, 4, 6, 8, 10].map((n) => (
                      <Button
                        key={n}
                        variant={guestFilter === n ? "default" : "outline"}
                        size="sm"
                        className="rounded-full w-9 h-9 p-0"
