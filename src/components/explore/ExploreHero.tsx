          ...
          <div className="flex flex-col sm:flex-row items-stretch gap-0 border border-border rounded-xl overflow-hidden bg-card shadow-[var(--shadow-card)]">
            <div className="flex-1 flex items-center gap-3 px-4 py-3.5 border-b sm:border-b-0 sm:border-r border-border">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[11px] text-muted-foreground font-medium leading-none mb-1">{t("search.destination")}</p>
                <Input
                  placeholder={t("search.countryOrZone")}
                  value={destination}
            ...
            <div className="flex-1 flex items-center gap-3 px-4 py-3.5 border-b sm:border-b-0 sm:border-r border-border">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[11px] text-muted-foreground font-medium leading-none mb-1">{t("search.stayDuration")}</p>
                <div className="flex items-center gap-1 text-sm font-medium text-foreground">
                  <Popover>
                    <PopoverTrigger asChild>
                      <button className="hover:text-primary transition-colors">
                        {checkIn ? format(checkIn, "dd/MM/yyyy", { locale: dateFnsLocale }) : <span className="text-muted-foreground/60">{t("search.arrival")}</span>}
                      </button>
                    </PopoverTrigger>
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      <button className="hover:text-primary transition-colors">
                        {checkOut ? format(checkOut, "dd/MM/yyyy", { locale: dateFnsLocale }) : <span className="text-muted-foreground/60">{t("search.departure")}</span>}
                      </button>
                    </PopoverTrigger>
                    <PopoverContent className="w-auto p-0" align="start">
            ...
            <div className="flex items-center gap-3 px-4 py-3.5">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-[11px] text-muted-foreground font-medium leading-none mb-1">{t("search.travelers")}</p>
                <Popover>
                  <PopoverTrigger asChild>
