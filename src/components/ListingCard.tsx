    ...
    >
      <Link to={`/property/${listing.id}`}>
        <div className="relative aspect-[4/3] overflow-hidden">
          ...
          <span className="absolute top-3 left-3 px-2.5 py-1 rounded-full bg-background/80 backdrop-blur-sm text-xs font-medium text-foreground capitalize">
      ...
      <div className="p-4">
        <h3 className="font-display font-semibold text-foreground text-base leading-tight line-clamp-1 mb-1">
          {listing.title}
        </h3>
        ...
        <div className="flex items-center gap-3 text-muted-foreground mb-3">
          <div className="flex items-center gap-1">
            ...
            <span className="text-sm">{listing.capacity} voyageur{listing.capacity > 1 ? "s" : ""}</span>
          </div>
          <div className="flex items-center gap-1">
            <Bed className="w-3.5 h-3.5" />
            <span className="text-sm">{listing.bedrooms} ch.</span>
          </div>
        </div>
